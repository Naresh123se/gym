...
{ 
    ...
    if (empty($fname)) {
        ...
        $sql = "INSERT INTO tbluser (fname, lname, email, mobile, state, city, age, password) 
                VALUES (:fname, :lname, :email, :mobile, :state, :city, :age, :Password)";
                ...
                <div class="col-lg-8">
                    ...
                    <form class="singup-form contact-form" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="age" id="age" placeholder="Your Age" autocomplete="off" value="<?php echo $age;?>" required>
                            </div>
                            <div class="col-md-6">
